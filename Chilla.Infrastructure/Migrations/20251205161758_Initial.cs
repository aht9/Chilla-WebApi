    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlanTemplateItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlanTemplateItems_Plans_PlanId",
                        column: x => x.PlanId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PlanTemplateItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ScheduledDate = table.Column<DateTime>(type: "date", nullable: false),
                    CompletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsCompleted = table.Column<bool>(type: "bit", nullable: false),
                    Value = table.Column<int>(type: "int", nullable: false),
                    IsLateEntry = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlanTemplateItems_PlanId",
                table: "PlanTemplateItems",
                column: "PlanId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestLogs_OccurredOn",
                table: "RequestLogs",
                column: "OccurredOn");
